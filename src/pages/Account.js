      ...
      <div className="w-5/6 p-5 space-y-4 rounded-lg ml-auto mr-2 mt-auto mb-auto">
        <div className="grid grid-cols-1 gap-6">
          ...
          <Card
            ...
            count="23"
            description="This system utilizes advanced AI to generate personalized CVs based on the user’s profile data."
            ...
            onButtonClick1={handleGenerateCV}
          ...
          <Card
            title="Applied Jobs"
            count="5"
            description="This system automates job applications by submitting tailored CVs to selected listings."
            subText="Pending 1"
          ...
          <Card
            ...
            count="23"
            description="This system generates customized cover letters by analyzing job descriptions and aligning them with user profiles."
            ...
            onButtonClick1={handleGenerateCL}
            onButtonClick2={handleViewCL}
          />
        </div>
      </div>
    </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className={`text-7xl font-bold mt-2 ${textColor} text-center`}>{count}</p>
        {subText && (
      ...
      <div className="flex flex-col w-3/4 gap-4">
        ...
        >
          <p className={`text-xl ${textColor} text-center m-auto`}>{description}</p>
        </div>
        <div
